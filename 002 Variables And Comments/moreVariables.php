...
<body>
    <div class="navbar bg-base-100 shadow-sm">
        <div class="navbar-start">
            ...
            <a class="btn btn-ghost text-xl">Gaurav UI</a>
        </div>
    ...
    <section>
        <br>
        <h1>Rules of Variables</h1>
        <p>In PHP, variable names must follow these rules:</p>
        <br>
        <ul>
            <li>Variable names must start with a letter or the underscore character.</li>
